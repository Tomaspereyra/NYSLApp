<template>
  ...
  <div class="card-body">
    <h5 class="card-title">U1 and U4</h5>
    <h6 class="card-subtitle mb-2 text-muted">9:30</h6>
    <p class="card-text">Detalles y descricion del partido.</p>
    <a href="#" class="card-link">Compartir partido</a>
...
export default {
  data(){
      return {
        ...
        messageList: [
            { type: 'text', author: `me`, data: { text: `Hola` } },
            { type: 'text', author: `user1`, data: { text: `Hola` } }
